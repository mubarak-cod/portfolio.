...
const contactPrompt = "Hi, I’d like to hire you for a project. Here’s what I’m looking for...";
      ...
      <div className="max-w-[1320px] mx-auto px-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Code size={28} className="w-6 h-6 text-primary" />

            <button
              onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
              className="text-2xl font-bold bg-linear-to-r from-primary via-primary/50 to-primary/30 text-transparent bg-clip-text"
            >
        ...
        <div
          className={`md:hidden transition-all duration-300 ${isMenuOpen ? "block" : "hidden"}`}
        >
          <div>
            {Nav_LINKS.map((link) => (
              <button
